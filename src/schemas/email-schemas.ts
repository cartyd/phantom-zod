...
export const createEmailSchemas = (messageHandler: ErrorMessageFormatter) => {
   ...
   */
  const createErrorMessage = (messageKey: EmailMessageKey, options: EmailSchemaOptions = {}, params: any = {}) => {
...
const { zEmailOptional: baseZEmailOptional, zEmailRequired: baseZEmailRequired } = createEmailSchemas(emailMessageHandler);
 ...
 * ```
 */
export const zHtml5EmailRequired = (options: Omit<EmailSchemaOptions, 'pattern'> = {}) => {
 ...
 */
export const zHtml5EmailOptional = (options: Omit<EmailSchemaOptions, 'pattern'> = {}) => {
 ...
 * ```
 */
export const zRfc5322EmailRequired = (options: Omit<EmailSchemaOptions, 'pattern'> = {}) => {
 ...
 */
export const zRfc5322EmailOptional = (options: Omit<EmailSchemaOptions, 'pattern'> = {}) => {
 ...
 * ```
 */
export const zUnicodeEmailRequired = (options: Omit<EmailSchemaOptions, 'pattern'> = {}) => {
 ...
 */
export const zUnicodeEmailOptional = (options: Omit<EmailSchemaOptions, 'pattern'> = {}) => {
